...
{
    [Serializable]
    public class UC3EnvironmentResetResponse : Message
    {
        public const string k_RosMessageName = "interfaces_pkg/UC3EnvironmentReset";
        ...
        public UC3AgentStateMsg state;
        public UC3AgentStateMsg target_state;

        public UC3EnvironmentResetResponse()
        {
            ...
            this.state = new UC3AgentStateMsg();
            this.target_state = new UC3AgentStateMsg();
        }

        public UC3EnvironmentResetResponse(BuiltinInterfaces.TimeMsg request_received_timestamp, BuiltinInterfaces.TimeMsg response_sent_timestamp, BuiltinInterfaces.TimeMsg response_received_timestamp, Sensor.CompressedImageMsg compressed_image, UC3AgentStateMsg state, UC3AgentStateMsg target_state)
        {
        ...
        public static UC3EnvironmentResetResponse Deserialize(MessageDeserializer deserializer) => new UC3EnvironmentResetResponse(deserializer);

        private UC3EnvironmentResetResponse(MessageDeserializer deserializer)
        {
            ...
            this.state = UC3AgentStateMsg.Deserialize(deserializer);
            this.target_state = UC3AgentStateMsg.Deserialize(deserializer);
        }
        ...
        {
            return "UC3EnvironmentResetResponse: " +
