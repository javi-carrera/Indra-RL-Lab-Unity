...
{
    [Serializable]
    public class UC3EnvironmentStepResponse : Message
    {
        ...
        public UC3EnvironmentStepResponse()
        {
        ...
        public UC3EnvironmentStepResponse(BuiltinInterfaces.TimeMsg request_received_timestamp, BuiltinInterfaces.TimeMsg response_sent_timestamp, BuiltinInterfaces.TimeMsg response_received_timestamp, Sensor.CompressedImageMsg compressed_image, UC3AgentStateMsg state, UC3AgentStateMsg target_state)
        {
        ...
        public static UC3EnvironmentStepResponse Deserialize(MessageDeserializer deserializer) => new UC3EnvironmentStepResponse(deserializer);

        private UC3EnvironmentStepResponse(MessageDeserializer deserializer)
        {
        ...
        {
            return "UC3EnvironmentStepResponse: " +
