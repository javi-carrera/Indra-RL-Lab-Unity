...
namespace RosMessageTypes.InterfacesPkg
{
    ...
    public class UC3EnvironmentStepResponse : Message
    {
        ...
        public UC3EnvironmentStepResponse(BuiltinInterfaces.TimeMsg request_received_timestamp, BuiltinInterfaces.TimeMsg response_sent_timestamp, BuiltinInterfaces.TimeMsg response_received_timestamp, Sensor.CompressedImageMsg compressed_image, UC3AgentStateMsg state)
        {
